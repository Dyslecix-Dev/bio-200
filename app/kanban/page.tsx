...
// const Board = () => {
//   const [cards, setCards] = useState<KanbanCardType[]>(DEFAULT_CARDS);

//   return (
//     <section className="relative z-20 flex justify-center h-full w-full gap-3 px-12 py-24">
//       <Column title="To-Do" column="todo" headingColor="text-red-300" cards={cards} setCards={setCards} />
...
// const Column = ({ title, headingColor, cards, column, setCards }: KanbanColumnPropsType) => {
//   const [active, setActive] = useState(false);

//   const handleDragStart = (e: React.DragEvent<HTMLDivElement> | MouseEvent | TouchEvent | PointerEvent, card: KanbanCardType) => {
...
//         if (insertAtIndex === -1) return; // Changed from undefined check to -1 check
...
//       </div>
//       <div onDrop={handleDragEnd} onDragOver={handleDragOver} onDragLeave={handleDragLeave} className={`h-full w-full transition-colors ${active ? "bg-neutral-800/50" : "bg-neutral-800/0"}`}>
//         {filteredCards.map((c) => {
...
// const Card = ({ title, id, column, handleDragStart }: KanbanCardPropsType) => {
//   return (
//     <>
...
//           handleDragStart(e as any, { title, id, column });
//         }}
...
// const BurnBarrel = ({ setCards }: BurnBarrelType) => {
//   const [active, setActive] = useState(false);
...
// const AddCard = ({ column, setCards }: AddKanbanCardPropsType) => {
...
// const DEFAULT_CARDS: KanbanCardType[] = [
//   // To-Do
//   {
