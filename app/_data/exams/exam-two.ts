export const trueOrFalseQuestions = [
  {
    question: "In cellular respiration, cells use oxygen to convert glycogen into ATP.",
    options: [
  ...
  {
    question: "The larynx is part of the upper respiratory tract.",
    options: [
  ...
  {
    question: "In normal breathing, air enters through the nostrils into the paranasal sinuses, down through the pharynx, and into the larynx.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "The nasal conchae and paranasal sinuses increase surface area for air contact with nasal mucus.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "The pharynx is the entrance to the trachea.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "The epiglottis is a cartilaginous 'trap door.'",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "Pronunciation depends on the 'shaping' of sounds by manipulation of the pharynx, tongue, and lips.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "The trachea descends from the larynx, and ends by dividing into two primary bronchi that each enter into one of the lungs.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "The left lung is split into three lobes.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "The bulk of the bronchial trees are part of the conducting zone of the respiratory system.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "The terminal branches and the air sacs at their tips are part of the conducting zone.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "Alveolar walls are made of a single, thin layer of epithelial cells.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "The accessory digestive organs aid in mechanically or chemically breaking down digested food.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "Most digestive organs are in the abdominal cavity.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "The central abdominal regions contain most of the large and small intestines.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "The visceral peritoneum lines the inner abdominopelvic walls and loosely wraps around the digestive organs.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "Propulsion, the movement of food through the alimentary canal, includes swallowing and peristalsis.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "Chemical digestion occurs in the mouth by mixing food with saliva, which contains enzymes.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "The bulk of a tooth is made of dentin, a spongy type of bone more similar to skeletal bone.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "The muscularis externa consists of two layers of skeletal muscle.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "The visceral peritoneum is the outermost lining of the alimentary canal.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "The esophagus is a continuation of the larynx.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "The lining epithelium of the stomach mucosa secretes a special type of buffered mucus that protects the stomach from pepsin and hydrochloric acid.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "The large intestine is the longest part of the alimentary canal, and is the site of most enzymatic digestion.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "The small intestine is where some absorption of nutrients occur.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "By the time chyme reaches the large intestine, it has few nutrients left and is mostly indigestible waste.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "The liver is the smallest gland in the body.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "Hepatocytes have a high capacity for cell division.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "The kidneys lie below the parietal peritoneum, specifically below the liver and stomach.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "Calices are where urine produced by kidney tissues is deposited.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "Major calices are formed by adjacent renal columns, and drain into minor calices, which drain into the renal pelvis.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "Nephrons and their convoluted tubules are entwined with peritubular capillaries.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
  ...
  {
    question: "Juxtamedullary nephrons produce the bulk of urine, and cortical nephrons contribute to concentrating the urine product.",
    options: [
      { text: "True", correct: false },
      { text: "False", correct: true },
    ],
  ...
  {
    question: "The ureters transport urine actively through peristalsis.",
    options: [
      { text: "True", correct: true },
      { text: "False", correct: false },
    ],
...
export const multipleChoiceQuestions = [
  {
    question: "Which of the following forms of respiration is gas exchange between the air in the lungs and the blood in capillaries that vascularize lung tissue?",
    options: [
      { text: "External respiration", correct: true },
      { text: "Pulmonary ventilation", correct: false },
      { text: "Transport of respiratory gases", correct: false },
      { text: "Internal respiration", correct: false },
      { text: "All of the given options", correct: false },
    ],
  },
  {
    question: "Which of the following forms of respiration uses the cardiovascular system?",
    options: [
      { text: "Transport of respiratory gases", correct: true },
      { text: "External respiration", correct: false },
      { text: "Pulmonary ventilation", correct: false },
      { text: "Internal respiration", correct: false },
  ...
  {
    question: "Which of the following structures is not part of the conducting zone?",
    options: [
  ...
  {
    question: "The nasal cavity is lined with what?",
    options: [
      { text: "Mucosa associated lymphoid tissue", correct: true },
      { text: "Mucus associated lymphoid tissue", correct: false },
      { text: "Mucin associated lymphoid tissue", correct: false },
      { text: "Mucina associated lymphoid tissue", correct: false },
      { text: "None of the given options", correct: false },
    ],
  },
  {
    question: "Which of the following is a region of the pharynx?",
    options: [
      { text: "Laryngopharynx", correct: true },
      { text: "Tracheopharynx", correct: false },
      { text: "Alveolopharynx", correct: false },
      { text: "Nasalopharynx", correct: false },
      { text: "Oralopharynx", correct: false },
    ],
  },
  {
    question: "Which of the following is not a function of the larynx?",
    options: [
      { text: "None of the given options", correct: true },
      { text: "Providing an open airway", correct: false },
      { text: "Producing vocalizations", correct: false },
      { text: "Switching mechanism for food", correct: false },
      { text: "Routing air to the proper channels", correct: false },
    ],
  },
  {
    question: "Which of the following does not act as a resonating chamber for amplifying sound?",
    options: [
  ...
  {
    question: "Which of the following structures is defined as terminal air sacs?",
    options: [
      { text: "Alveoli", correct: true },
      { text: "Bronchi", correct: false },
      { text: "Lungs", correct: false },
      { text: "Bronchial trees", correct: false },
      { text: "Alveolar sacs", correct: false },
    ],
  },
  {
    question: "Which of the following is not a structure of the alimentary canal?",
    options: [
      { text: "Trachea", correct: true },
      { text: "Pharynx", correct: false },
      { text: "Esophagus", correct: false },
      { text: "Small intestines", correct: false },
      { text: "Large intestines", correct: false },
    ],
  },
  {
    question: "Which of the following is not a function of the alimentary canal?",
    options: [
      { text: "Chewing food", correct: true },
      { text: "Propelling food through the body", correct: false },
      { text: "Digesting nutrients", correct: false },
      { text: "Absorbing nutrients", correct: false },
      { text: "Expelling waste", correct: false },
    ],
  },
  {
  ...
  {
    question: "In abdominal regions, the lower horizontal line connects what?",
    options: [
      { text: "Widest points of the iliac crests", correct: true },
      { text: "Inferior points of the costal margins", correct: false },
      { text: "Midpoint of the clavicles", correct: false },
      { text: "Fusion of the pubic symphysis", correct: false },
      { text: "None of the given options", correct: false },
    ],
  },
  {
    question: "Which of the following is not an organ in the inferior three abdominal regions?",
    options: [
  ...
  {
    question: "Which of the following is the largest mesentary?",
    options: [
      { text: "Greater omentum", correct: true },
      { text: "Superior omentum", correct: false },
      { text: "Main omentum", correct: false },
      { text: "Vast omentum", correct: false },
      { text: "Massive omentum", correct: false },
    ],
  },
  {
    question: "Which of the following is not an essential food-processing activity of the digestive system?",
    options: [
      { text: "Masticulation", correct: true },
      { text: "Propulsion", correct: false },
      { text: "Mechanical breakdown", correct: false },
      { text: "Absorption", correct: false },
      { text: "Defecation", correct: false },
    ],
  },
  {
    question: "How many permanent teeth is a full set?",
    options: [
  ...
  {
    question: "Which of the following is not a classification of teeth?",
    options: [
      { text: "Lateral", correct: true },
      { text: "Incisor", correct: false },
      { text: "Canine", correct: false },
      { text: "Bicuspid", correct: false },
      { text: "Molar", correct: false },
    ],
  },
  {
    question: "Which of the following is not a function of saliva?",
    options: [
      { text: "Mechanical breakdown of food", correct: true },
      { text: "Moistens the mouth", correct: false },
      { text: "Dissolves food chemicals", correct: false },
      { text: "Binds food into a bolus", correct: false },
      { text: "Kills foreign bacteria", correct: false },
    ],
  },
  {
    question: "Which of the following is not a tissue of the walls of the alimentary canal?",
    options: [
      { text: "Muscularis interna", correct: true },
      { text: "Mucosa", correct: false },
      { text: "Submucosa", correct: false },
      { text: "Muscularis externa", correct: false },
      { text: "Serosa", correct: false },
    ],
  },
  {
    question: "Which enzyme chemically breaks down food proteins within the stomach?",
    options: [
      { text: "Pepsin", correct: true },
      { text: "Bismisin", correct: false },
      { text: "Tumsin", correct: false },
      { text: "Probiosin", correct: false },
      { text: "Cocasin", correct: false },
    ],
  },
  {
    question: "Which of the following is not a region of the small intestine?",
    options: [
      { text: "Avarium", correct: true },
  ...
  {
    question: "Which of the following is not a structural modification of the inner wall of the small intestine?",
    options: [
  ...
  {
    question: "Which of the following is not a functional example of the liver?",
    options: [
      { text: "Converting glycogen into glucose", correct: true },
      { text: "Processing amino acids", correct: false },
      { text: "Storing certain vitamins", correct: false },
      { text: "Detoxifying poisons", correct: false },
      { text: "Producing blood proteins", correct: false },
    ],
  },
  {
    ...
    options: [
      ...
      { text: "Ureters", correct: false },
      { text: "Urinary bladder", correct: false },
      { text: "Urethra", correct: false },
    ],
  },
  {
    question: "Which of the following is not a nitrogenous compound excreted by urine?",
    options: [
  ...
  {
    question: "Where does uric acid come from?",
    options: [
      { text: "Replacing nucleic acids", correct: true },
      { text: "Breakdown of proteins", correct: false },
      { text: "Breakdown of muscle energy storage molecules", correct: false },
      { text: "Replacing lipids", correct: false },
      { text: "Breakdown of amino acids", correct: false },
    ],
  },
  {
    question: "Which is a distinct region of kidney tissue?",
    options: [
      { text: "Renal medulla", correct: true },
      { text: "Renal endosteo", correct: false },
      { text: "Renal epiphysia", correct: false },
      { text: "Renal diaphysia", correct: false },
      { text: "Renal periosteo", correct: false },
    ],
  },
  {
    question: "Extensions of the renal cortex dip down between what to form renal columns?",
    options: [
      { text: "Renal pyramids", correct: true },
      { text: "Renal cuboids", correct: false },
      { text: "Renal columnars", correct: false },
      { text: "Renal trapezoids", correct: false },
      { text: "Renal cones", correct: false },
    ],
  },
  {
    question: "At any given moment, both kidneys hold more than what percent of the body's total blood volume?",
    options: [
  ...
  {
    question: "Which of the following are found in the medulla of nephrons?",
    options: [
      { text: "Nephron loop", correct: true },
      { text: "Renal corpuscles", correct: false },
      { text: "Proximal convoluted tubules", correct: false },
      { text: "Distal convoluted tubules", correct: false },
      { text: "Glomerulus", correct: false },
    ],
  },
  {
    question: "Which of the following leak blood plasma?",
    options: [
      { text: "Glomerulus", correct: true },
      { text: "Nephron loop", correct: false },
      { text: "Renal corpuscles", correct: false },
      { text: "Proximal convoluted tubules", correct: false },
      { text: "Distal convoluted tubules", correct: false },
    ],
  ...
  {
    question: "Which of the following is not a renal process nephron performs?",
    options: [
      { text: "Renal diffusion", correct: true },
      { text: "Glomerular filtration", correct: false },
      { text: "Tubular resorption", correct: false },
      { text: "Tubular secretion", correct: false },
      { text: "None of the given options", correct: false },
    ],
  },
  {
    question: "The urinary bladder is posterior to which structure?",
    options: [
      { text: "Pubic symphysis", correct: true },
      { text: "Inferior pelvic region", correct: false },
...
export const shortAnswerQuestions = [
  {
    question: "What does the conducting zone do to the air we inhale?",
    answer: "It filters, humidifies, and warms incoming air.",
  },
  {
    question: "In normal breathing, detail the structures the air is drawn through in order.",
    answer: "Nasal cavity, pharynx, larynx, trachea, lungs, then bronchi.",
  },
  {
    question: "What dictates the pitch of produced sounds from forced exhalation?",
    answer: "Length and tension of the vocal cords, and the width of the glottis.",
  },
  {
    question: "What occurs at the alveoli?",
    answer: "Gas diffusion between the thin alveolar walls and thin capillary walls.",
  },
  {
    question: "How does inspiration and expiration work mechanistically?",
    answer:
      "When the diaphragm contracts, the lungs expand, causing the air pressure to decrease and draw in air from the external environment. When the diaphragm relaxes, the lungs shrink, causing the air pressure to increase and expel air into the external environment.",
  },
  {
    question: "What are the two main groups of the digestive system?",
    answer: "Alimentary canal (i.e. gastrointestinal tract) organs, and accessory digestive organs.",
  },
  {
    question: "What are the 3 functions of mesentaries?",
    answer: "Hold organs in place, store fat, and provide scaffolding for circulatory vessels and nerves to reach organs.",
  },
  {
    question: "What are the 2 main regions of teeth?",
    answer: "An exposed crown, and hidden roots in the socket.",
  },
  {
    question: "What is the function of the epithelium lining of the lumen (part of the mucosa) in small intestines?",
    answer: "It absorbs nutrients and passes them to the blood vessels of the lamina propria.",
  },
  {
    question: "What are 2 differences between the pharynx and the esophagus?",
    answer: "The esophagus has a collapsed lumen, and its walls contain all four tissue layers of the alimentary canal.",
  },
  {
    question: "Most digestive organs are secreted into the duodenum from which 2 organs?",
    answer: "Pancreas and liver.",
  },
  {
    question: "What does the gallbladder do?",
    answer: "It stores and concentrates bile from the liver.",
  },
  {
    question: "What is the function of the kidneys?",
    answer: "They maintain the chemical constancy of the blood and extracellular body fluids.",
  },
  {
    question: "Which 2 things hold the kidneys in place?",
    answer: "Surrounding layers of perirenal and pararenal fat, and renal fascia.",
  },
  {
    question: "Why are the kidneys heavily vascularized?",
    answer: "Because they filter the body's blood.",
  },
  {
    question: "What are the 2 classes of nephrons?",
